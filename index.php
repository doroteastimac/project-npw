...
<html>
	<head>
		...
		<meta itemprop="name" content="Putovanja">
		<meta itemprop="description" content="Some description">
		<meta itemprop="image" content="Your URL"> 
		
		<!-- Open Graph data -->
		<meta property="og:title" content="Putovanja">
        ...
        <meta name="author" content="dstima2@vvg.hr">
		<!-- favicon meta -->
...
<body>
	...
	# API OMDB
	else if ($menu == 10) { include("freetime.php"); }
	...
	<footer>
		<p>Copyright &copy; ' . date("Y") . ' Dorotea Štimac. <a href="https://github.com/doroteastimac/project-npw" style="color:#fff">GITHub</a></p>
	</footer>
</body>
</html>';
?>
